function [reg_corner,rho_c,eta_c,reg_param] = l_curve_modified(U,sm,b,method,plotCorner,L,V)
...
% use l_corner_modified (discrete computation to find corner), optional plot
